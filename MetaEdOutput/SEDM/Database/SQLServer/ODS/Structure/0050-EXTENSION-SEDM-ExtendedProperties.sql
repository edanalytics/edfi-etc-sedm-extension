...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A reference to one or more student IDEA events.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the most recent IEP was finalized.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'IEPFinalizedDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'IEPServicingEducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date the service was prescribed.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'ServicePrescriptionDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The type of service prescribed. Examples include: Auditory Specialist, Vocational Therapy.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'ServicePrescriptionDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier assigned by the provider or source system of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'StudentIEPAssociationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique alphanumeric code assigned to a student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'StudentUSI'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'EducationOrganizationId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The IDEA event recorded for the student.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'IDEAEventDescriptorId'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier for the event record as assigned by the provider of IEP services.', @level0type=N'SCHEMA', @level0name=N'sedm', @level1type=N'TABLE', @level1name=N'IEPServicePrescriptionIDEAEvent', @level2type=N'COLUMN', @level2name=N'IDEAEventID'
GO
